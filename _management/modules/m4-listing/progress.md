...
## P-043 主图造假缺陷修正（2026-09-01 ｜ 用户指正「每张图一模一样」）

- **缺陷**：P-042 把同一图缩放回 800×800 当 5 张主图——SHA256 骗过 R21，肉眼同图。
- **改正**：卖家式真实变体（main_0 整版 / main_1 2.0x 特写 / main_2 灰底 / main_3 红带热卖 / main_4 蓝带新品上架），dhash 与主图差异 6-38 肉眼可辨。
- **结果**：61/65 素材齐全（4 个下载失败登记待补），门禁 61/65 通过，pending 素材已更新。
- **登记**：pitfall-log P-043。
